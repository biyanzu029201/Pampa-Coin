...
// Copyright (c) 2017 The PampaCoin developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("00000e402e935df33b0572a9f2e510f7513fbf796d9de85eaa3333e85520d532"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 51562;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // PampaCoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 120; // PampaCoin: 2 minute
        nTargetSpacing = 1 * 120;  // PampaCoin: 2 minute
        nPastBlocksMin = 24;
        nLastPOWBlock = 10080;
        nMaturity = 90;
        nMasternodeCountDrift = 20;
        nModifierUpdateBlock = 0;
        nMaxMoneyOut = int64_t(9500000000) * COIN;
        ...
        nRequiredMasternodeCollateral = 2000000 * COIN; //10,000,000
         ...
         *   vMerkleTree: e0028e
         */
        const std::string pszTimestamp = "PAMPACOIN starts";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1525832014;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 3001391;
...
/*printf("Searching for genesis block...\n");
        ...
        assert(hashGenesisBlock == uint256("0x00000e402e935df33b0572a9f2e510f7513fbf796d9de85eaa3333e85520d532"));
        assert(genesis.hashMerkleRoot == uint256("0x8bdc078987244bd5a34776615a8253aff8befed6f125b5fbb446b8907fc034ce"));

       // vSeeds.push_back(CDNSSeedData("pampa", "seed.pampacoin.org"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // PampaCoin: 1 day
        nTargetSpacing = 1 * 60;  // PampaCoin: 1 minute
        nPastBlocksMin = 200;
        nLastPOWBlock = 200;
        nMaturity = 15;
...
/*printf("Searching for genesis block...\n");
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet pampa addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet pampa script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet pampa BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet pampa BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet pampa BIP44 coin type is '1' (All coin's testnet default)
...
/*printf("Searching for genesis block...\n");
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 51476;
        assert(hashGenesisBlock == uint256("0x5eada5014e3930896ebfd2eaede5e5aefe3bce4a1ce0bb0b2ed8e6df910541c8"));
