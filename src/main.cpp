...
#if defined(NDEBUG)
#error "PAMPA cannot be compiled without assertions."
#endif
...
{
    /**
     * Block 1: 12 Billions PAMPA pre-mined
     Block Reward:
     Blocks 2 - 151,200 - 2500 PAMPA
     Blocks 151,201 - 302,399 - 1250 PAMPA
     Blocks 302,400 - Infinite:  1000 PAMPA
