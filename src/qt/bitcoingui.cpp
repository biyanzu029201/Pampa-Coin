                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PampaCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PampaCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pampa: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PampaCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about PampaCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PampaCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PampaCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PampaCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a PampaCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PampaCoin Core help message to get a list with possible PampaCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PampaCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PampaCoin network", "", count));
}
...
{
    QString strTitle = tr("PampaCoin Core"); // default title
