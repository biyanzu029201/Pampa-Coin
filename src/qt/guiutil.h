...
/** Utility functions used by the PampaCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render PampaCoin addresses in monospace font
...
// Parse "pampa:" URI into recipient object, return true on successful parsing
