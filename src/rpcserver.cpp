...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"pampa", "masternode", &masternode, true, true, false},
        {"pampa", "masternodelist", &masternodelist, true, true, false},
        {"pampa", "mnbudget", &mnbudget, true, true, false},
        {"pampa", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"pampa", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pampa", "mnsync", &mnsync, true, true, false},
        {"pampa", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"pampa", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use pampad, or the -server option to pampa-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> pampa-cli " + methodname + " " + args + "\n";
}
