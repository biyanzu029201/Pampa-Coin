...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<pampa_address\> \<monthly_payment_pampa\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ PAMPA, _12_ times over the course of a year totaling _24000_ PAMPA.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<pampa_address\> \<monthly_payment_pampa\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` PAMPA.
