...
This mechanism has been integrated into Bitcore-Node-PAMPA which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PAMPA-Project/insight-api-pampa#web-socket-api](https://github.com/PAMPA-Project/insight-api-pampa#web-socket-api)
* API: [https://github.com/PAMPA-Project/insight-api-pampa#swifttx-transactions](https://github.com/PAMPA-Project/insight-api-pampa#swifttx-transactions)
...
By default, the PAMPA Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PAMPA Core daemon:
