...
In order to support loading of multiple wallets in pampa-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pampa.cpp.
...
Changes to pampa.cpp
----------------------
pampa.cpp is the entry point into pampa-qt, and as such, will require some minor modifications to provide hooks for
