...
The following applies to code changes to the PAMPA Core project, and is not to be
confused with overall PAMPA Network Protocol consensus changes.

Whether a pull request is merged into PAMPA Core rests with the project merge
...
Patches that change PAMPA consensus rules are considerably more involved than
...
Where a patch set proposes to change the PAMPA consensus, it must have been
...
The project leader is the release manager for each PAMPA Core release.
