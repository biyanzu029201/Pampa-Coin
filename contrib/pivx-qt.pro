...
RESOURCES += src/qt/pampa.qrc src/qt/pampa_locale.qrc

TRANSLATIONS += src/qt/locale/pampa_bg.ts \
                src/qt/locale/pampa_de.ts \
                src/qt/locale/pampa_en.ts \
                src/qt/locale/pampa_es.ts \
                src/qt/locale/pampa_fi.ts \
                src/qt/locale/pampa_fr.ts \
                src/qt/locale/pampa_it.ts \
                src/qt/locale/pampa_ja.ts \
                src/qt/locale/pampa_pl.ts \
                src/qt/locale/pampa_pt.ts \
                src/qt/locale/pampa_ru.ts \
                src/qt/locale/pampa_sk.ts \
                src/qt/locale/pampa_sv.ts \
                src/qt/locale/pampa_vi.ts \
                src/qt/locale/pampa_zh_CN.ts \
                src/qt/locale/pampa_zh_TW.ts
