...
This means one can have an always-on pampad instance running, and another local pampad/pampa-qt instance which connects to this node and receives blocks from it.
